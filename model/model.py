...
from .layers_5 import SpeakerClassifier, SpeakerEncoder, AudioSeq2seq, TextEncoder,  PostNet, MergeNet, GST
import pdb
...
class Parrot(nn.Module):
    ...
    def forward(self, inputs, input_text):
        ...
        #speaker_logit_from_mel, speaker_embedding = self.speaker_encoder(mel_padded, mel_lengths,text_hidden,text_lengths ) 
        ...
        outputs = [predicted_mel, post_output, predicted_stop, alignments,
                  ...
                  text_lengths, mel_lengths, SE_alignments]
