...
CUDA_VISIBLE_DEVICES=0 python train.py -l logdir \
-o outdir_100 -c /home/hk/voice_conversion/nonparaSeq2seqVC_text-dependent_SE/outdir_100/checkpoint_196000  --hparams=speaker_adversial_loss_w=30.,ce_loss=False,speaker_classifier_loss_w=0.1,contrastive_loss_w=30.
