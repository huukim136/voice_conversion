...
CUDA_VISIBLE_DEVICES=0 python train.py -l logdir \
-o outdir_100_reduce_size_of_frame_spk_embeddings_to_128_frames_visual  --hparams=speaker_adversial_loss_w=30.,ce_loss=False,speaker_classifier_loss_w=0.1,contrastive_loss_w=30.
