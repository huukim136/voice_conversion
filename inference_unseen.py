...
from reader.reader_unseen import TextMelIDLoader, TextMelIDCollate
...
tlist = '/home/hk/voice_conversion/nonparaSeq2seqVC_text-dependent_SE/reader/inference_255to315.txt'

# use seen (tlist) or unseen list (hlist)
test_list = tlist
checkpoint_path='outdir_100speaker_ref_attention_addition_normed/checkpoint_75000'
# TTS or VC task?
input_text= False
...
with torch.no_grad():
    ...
    for i, batch in enumerate(test_loader):
        ...
        plot_data([alignments, SE_alignment], 
            os.path.join(path_save, 'SE_%s_ref_%s_%s.pdf'%(sample_id, ref_sp, task)))
