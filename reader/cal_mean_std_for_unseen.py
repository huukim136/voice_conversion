...
# max_cur = [0]*80
# std_list=[]
list_file = '/home/hk/voice_conversion/nonparaSeq2seqVC_text-dependent_SE/reader/unseen/list.txt'
...
np.save('spk_embeddings/std_unseen1.npy', std_val)
np.save('spk_embeddings/mean_unseen1.npy', mean_val)
